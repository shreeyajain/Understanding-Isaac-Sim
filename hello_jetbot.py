...
class HelloJetbot(BaseSample):
    ...
    async def setup_post_load(self):
        ...
        print("calling add_physics_callback")
        self._world.add_physics_callback("sending_actions", callback_fn=self.send_robot_actions)
        return
    
    async def setup_post_reset(self):
        # Print info about the jetbot after each reset is called
        print("Num of degrees of freedom after reset: " + str(self._jetbot.num_dof)) # prints 2
        print("Joint Positions after reset: " + str(self._jetbot.get_joint_positions()))
